...
#define INA219_CONFIG_BVOLTAGERANGE_MASK (0x2000) // Bus Voltage Range Mask // (0x2000) -> Original

/** bus voltage range values **/
enum {
  INA219_CONFIG_BVOLTAGERANGE_16V = (0x0000), // 0-16V Range
  INA219_CONFIG_BVOLTAGERANGE_32V = (0x2000), // 0-32V Range // (0x2000) -> Original
};
...
enum
{
    INA219_CONFIG_GAIN_1_40MV = (0x0000),  // Gain 1, 40mV Range  // (0x0000) -> Original
    INA219_CONFIG_GAIN_2_80MV = (0x0800),  // Gain 2, 80mV Range  // (0x0800) -> Original
    INA219_CONFIG_GAIN_4_160MV = (0x1000), // Gain 4, 160mV Range // (0x1000) -> Original
    INA219_CONFIG_GAIN_8_320MV = (0x1800), // Gain 8, 320mV Range // (0x1800) -> Original
};
