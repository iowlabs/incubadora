 ...
 *     only supporting 16V at 400mA max.
 */
void Adafruit_INA219::setCalibration_24V_20mA()
{
  ...
  // RSHUNT     = 16            (Resistor value in ohms)

  // VSHUNT_MAX = 0.04          (Assumes Gain 1, 40mV)
  // RSHUNT     = 2             (Resistor value in ohms)
  ...
  // 3. Calculate possible range of LSBs (Min = 15-bit, Max = 12-bit)
  // MinimumLSB = MaxExpected_I/32767
  // MinimumLSB = 0.000061037            (61uA per bit)
  // MaximumLSB = MaxExpected_I/4096
  // MaximumLSB = 0.000488281            (488uA per bit)

  // 4. Choose an LSB between the min and max values
  //    (Preferrably a roundish number close to MinLSB)
  // CurrentLSB = 0.000065 (65uA per bit)

  // 5. Compute the calibration register
  // Cal = trunc (0.04096 / (Current_LSB * RSHUNT))
  // Cal = 39 (0x0027)

  ina219_calValue = 315; // RSHUNT  2
  //ina219_calValue = 39; // RSHUNT 16
  ...
  //
  // Max_ShuntVoltage_Before_Overflow = VSHUNT_MAX
  // Max_ShuntVoltage_Before_Overflow = -
  ...
  // Set multipliers to convert raw current/power values
  //ina219_currentDivider_mA = 20;    // Current LSB = 50uA per bit (1000/50 = 20)
  ina219_currentDivider_mA = 14;    // Current LSB = 50uA per bit (1000/65 = 15.38)
  ina219_powerMultiplier_mW = 1.0f; // Power LSB = 1mW per bit
