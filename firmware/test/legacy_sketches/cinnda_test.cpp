...
Cuenta con un control de temperatura por medio de un PID. Ademas. recibe comandos vía serial y actualiza el sp de temperatura y las rpm del shaker
...
// Constantes
#define STARTING_SETPOINT 			10.0   // Pin conectado a DT (encoder)
...
//MQTT
#define PUBLISH_TOPIC  	"id.up"

#define mqtt_server 	"mqtt.q4t.cl"
#define mqtt_user 		"tds"
#define mqtt_password 	"m0squ1t0tds"
#define mqtt_port 1884

// Configuración de la red Wi-Fi
const char* ssid = "ovales 5G";
const char* password = "Cinnda2023!!";
...
void publishData()
{
	...
	doc_tx["co2"]   = 0.0;
	doc_tx["tvoc"]  = 0.0;
	doc_tx["radiation"] = 0.0;
	doc_tx["noise_max"] 	= 0.0;
	doc_tx["noise_mean"] 	= 0.0;
	doc_tx["lat"]   = 0.0;
	doc_tx["lon"]  	= 0.0;
...
void reconnect()
{
	...
	else
	{
		...
		while (!client.connected())
		{
	    	...
	    	if (client.connect("OVAL33", mqtt_user, mqtt_password))
			{
